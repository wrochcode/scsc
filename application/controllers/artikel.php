...
class artikel extends CI_Controller
{
    public function index()
    {
        ...
        $this->load->view('layanan/sidearticle', $data);
    ...
    public function kategori($detail)
    {
        $data['title'] = "SCSC - Artikel - Detail";
        // var_dump();
        $dataPenunjuk = $this->session->userdata('email');
        ...
        $tempVar = $this->scsc->getData("artikel_category",array('slug'=>$detail));
        $data['components'] = $tempVar;
        // var_dump($data['components']);
        ...
        $tempVar = $this->scsc->getData("artikel",array('category'=>$detail));
        $data['articles'] = $tempVar;
